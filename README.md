...
Selain itu, terdapat class **`Transaction`** yang berfungsi untuk mengelola proses penjualan, seperti menambahkan produk ke dalam transaksi dan menghitung total harga setelah diskon.
